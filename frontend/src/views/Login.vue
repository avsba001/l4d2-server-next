...
<template>
  <div class="min-h-screen bg-gray-100 flex flex-col justify-center items-center p-4">
    <div class="text-center mb-8 flex flex-col items-center">
      ...
      <p class="text-gray-500">服务器管理面板</p>
    </div>

    <a-card class="w-full max-w-md shadow-xl" :bordered="false">
      <form @submit.prevent="handleLogin">
        <div class="mb-6">
          <label class="block text-gray-700 text-sm font-bold mb-2"> 访问密码 / 授权码 </label>
          <a-input-password
